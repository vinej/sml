...
static int ke_plimage(ke1_t *stack, int top) {
...
static int ke_pljoin(ke1_t *stack, int top) {
	ke1_t *x1, *y1, *x2, *y2;
	y2 = &stack[--top];
	x2 = &stack[--top];
	y1 = &stack[--top];
...
static int ke_pllab(ke1_t *stack, int top) {
...
static int ke_pllegend(ke1_t *stack, int top) {
	...
	pllegend(
		(PLFLT_NC_SCALAR)(&(g_gbl_fields[p_legend_width->ifield]->r)),
		(PLFLT_NC_SCALAR)(&(g_gbl_fields[p_legend_height->ifield]->r)),
		(PLINT)opt->i, 
		(PLINT)position->i, 
		(PLFLT)x->r, 
		(PLFLT)y->r, 
...
static int ke_pllightsource(ke1_t *stack, int top) {
	ke1_t *x, *y, *z;
	z = &stack[--top];
	y = &stack[--top];
	x = &stack[--top];
...
static int ke_plline3(ke1_t *stack, int top) {
	ke1_t *n, *x, *y, *z;
	z = &stack[--top];
	y = &stack[--top];
	x = &stack[--top];
...
static int ke_pllsty(ke1_t *stack, int top) {
	ke1_t *lin;
	lin = &stack[--top];
...
// TODO gin
static int ke_plmap(ke1_t *stack, int top) {
...
// TODO 
static int ke_plmapline(ke1_t *stack, int top) {
	ke1_t *mapform, *name, *minx, *maxx, *miny, *maxy, *plotentries, *nplotentries;
	nplotentries = &stack[--top];
	plotentries = &stack[--top];
	maxy = &stack[--top];
...
// TODO 
static int ke_plmapstring(ke1_t *stack, int top) {
...
// TODO 
static int ke_plmaptex(ke1_t *stack, int top) {
...
static int ke_plmeridians(ke1_t *stack, int top) {
...
static int ke_plmesh(ke1_t *stack, int top) {
...
static int ke_plmeshc(ke1_t *stack, int top) {
...
static int ke_plmkstrm(ke1_t *stack, int top) {
	ke1_t *p_strm;
	p_strm = &stack[--top];

	plmkstrm((PLINT_NC_SCALAR)(&(g_gbl_fields[p_strm->ifield]->i)));
	return top;
}

static int ke_plmtex(ke1_t *stack, int top) {
...
static int ke_plmtex3(ke1_t *stack, int top) {
	ke1_t *side, *disp, *pos, *just, *text;
	text = &stack[--top];
	just = &stack[--top];
	pos = &stack[--top];
...
static int ke_plot3d(ke1_t *stack, int top) {
...
static int ke_plot3dc(ke1_t *stack, int top) {
	ke1_t *x, *y, *z, *nx, *ny, *opt, *clevel, *nlevel;
	nlevel = &stack[--top];
	clevel = &stack[--top];
	opt = &stack[--top];
...
static int ke_plot3dl(ke1_t *stack, int top) {
...
static int ke_plparseopts(ke1_t *stack, int top) {
	...
	PLINT st = plparseopts(
		(int *)(&(g_gbl_fields[p_argc->ifield]->i)),
...
static int ke_plpat(ke1_t *stack, int top) {
	ke1_t *nlin, *inc, *del;
	del = &stack[--top];
	inc = &stack[--top];
	nlin = &stack[--top];
...
static int ke_plpath(ke1_t *stack, int top) {
	ke1_t *n, *x1, *y1, *x2, *y2;
	y2 = &stack[--top];
	x2 = &stack[--top];
	y1 = &stack[--top];
...
static int ke_plpoin(ke1_t *stack, int top) {
	ke1_t *n, *x, *y, *code;
	code = &stack[--top];
	y = &stack[--top];
	x = &stack[--top];
...
static int ke_plpoin3(ke1_t *stack, int top) {
	ke1_t *n, *x, *y, *z, *code;
	code = &stack[--top];
	z = &stack[--top];
	y = &stack[--top];
...
static int ke_plpoly3(ke1_t *stack, int top) {
...
static int ke_plprec(ke1_t *stack, int top) {
	ke1_t *setp, *prec;
	prec = &stack[--top];
	setp = &stack[--top];
...
static int ke_plpsty(ke1_t *stack, int top) {
	ke1_t *patt;
	patt = &stack[--top];
...
static int ke_plptex(ke1_t *stack, int top) {
...
static int ke_plptex3(ke1_t *stack, int top) {
...
static int ke_plrandd(ke1_t *stack, int top) {
	ke1_t *p;
	p = &stack[top - 1];
	stack[top++] = *p;
	p = &stack[top - 1];
...
static int ke_plreplot(ke1_t *stack, int top) {
	plreplot();
	return top;
}

static int ke_plrgbhls(ke1_t *stack, int top) {
	...
	plrgbhls(
		...
		(PLFLT)g->r,
		(PLFLT)b->r,
		(PLFLT_NC_SCALAR)(&(g_gbl_fields[p_h->ifield]->r)),
		(PLFLT_NC_SCALAR)(&(g_gbl_fields[p_l->ifield]->r)),
		(PLFLT_NC_SCALAR)(&(g_gbl_fields[p_s->ifield]->r)));
	return top;
}

static int ke_plschr(ke1_t *stack, int top) {
	ke1_t *def, *scale;
	scale = &stack[--top];
	def = &stack[--top];
...
static int ke_plscmap0(ke1_t *stack, int top) {
	ke1_t *r, *g, *b, *ncol0;
	ncol0 = &stack[--top];
	b = &stack[--top];
	g = &stack[--top];
...
static int ke_plscmap0a(ke1_t *stack, int top) {
...
static int ke_plscmap0n(ke1_t *stack, int top) {
	ke1_t *ncol0;
	ncol0 = &stack[--top];
...
static int ke_plscmap1_range(ke1_t *stack, int top) {
	ke1_t *min_color, *max_color;
	max_color = &stack[--top];
	min_color = &stack[--top];
...
static int ke_plscmap1(ke1_t *stack, int top) {
	ke1_t *r, *g, *b, *ncol1;
	ncol1 = &stack[--top];
	b = &stack[--top];
	g = &stack[--top];
...
static int ke_plscmap1a(ke1_t *stack, int top) {
...
static int ke_plscmap1l(ke1_t *stack, int top) {
...
static int ke_plscmap1la(ke1_t *stack, int top) {
...
static int ke_plscmap1n(ke1_t *stack, int top) {
	ke1_t *ncol1;
	ncol1 = &stack[--top];
...
static int ke_plscol0(ke1_t *stack, int top) {
	ke1_t *icol0, *r, *g, *b;
	b = &stack[--top];
	g = &stack[--top];
	r = &stack[--top];
...
static int ke_plscol0a(ke1_t *stack, int top) {
	ke1_t *icol0, *r, *g, *b, *alpha;
	alpha = &stack[--top];
	b = &stack[--top];
	g = &stack[--top];
...
static int ke_plscolbg(ke1_t *stack, int top) {
	ke1_t *r, *g, *b;
	b = &stack[--top];
	g = &stack[--top];
	r = &stack[--top];
...
static int ke_plscolbga(ke1_t *stack, int top) {
	ke1_t *r, *g, *b, *alpha;
	alpha = &stack[--top];
	b = &stack[--top];
	g = &stack[--top];
...
static int ke_plscolor(ke1_t *stack, int top) {
	ke1_t *color;
	color = &stack[--top];
...
static int ke_plscompression(ke1_t *stack, int top) {
	ke1_t *compression;
	compression = &stack[--top];
...
static int ke_plsdidev(ke1_t *stack, int top) {
...
static int ke_plsdimap(ke1_t *stack, int top) {
...
static int ke_plsdiori(ke1_t *stack, int top) {
	ke1_t *rot;
	rot = &stack[--top];
...
static int ke_plsdiplt(ke1_t *stack, int top) {
...
static int ke_plsdiplz(ke1_t *stack, int top) {
	ke1_t *xmin, *ymin, *xmax, *ymax;
	ymax = &stack[--top];
	xmax = &stack[--top];
	ymin = &stack[--top];
...
static int ke_plsdrawmode(ke1_t *stack, int top) {
	ke1_t *mode;
	mode = &stack[--top];
...
static int ke_plseed(ke1_t *stack, int top) {
	ke1_t *seed;
	seed = &stack[--top];
...
static int ke_plsesc(ke1_t *stack, int top) {
	ke1_t *esc;
	esc = &stack[--top];
...
static int ke_plsetopt(ke1_t *stack, int top) {
	ke1_t *opt, *optarg;
	optarg = &stack[--top];
	opt = &stack[top - 1];
...
static int ke_plsfam(ke1_t *stack, int top) {
	ke1_t *fam, *num, *bmax;
	bmax = &stack[--top];
	num = &stack[--top];
	fam = &stack[--top];
...
static int ke_plsfci(ke1_t *stack, int top) {
	ke1_t *fci;
	fci = &stack[--top];
...
static int ke_plsfnam(ke1_t *stack, int top) {
	ke1_t *fnam;
	fnam = &stack[--top];
...
static int ke_plsfont(ke1_t *stack, int top) {
...
static int ke_plshades(ke1_t *stack, int top) {
...
static int ke_plshade(ke1_t *stack, int top) {
...
static int ke_plslabelfunc(ke1_t *stack, int top) {
...
static int ke_plsmaj(ke1_t *stack, int top) {
	ke1_t *def, *scale;
	scale = &stack[--top];
	def = &stack[--top];
...
static int ke_plsmem(ke1_t *stack, int top) {
...
static int ke_plsmema(ke1_t *stack, int top) {
	ke1_t *maxx, *maxy, *plotmem;
	plotmem = &stack[--top];
	maxy = &stack[--top];
	maxx = &stack[--top];
...
static int ke_plsmin(ke1_t *stack, int top) {
	ke1_t *def, *scale;
	scale = &stack[--top];
	def = &stack[--top];
...
static int ke_plsori(ke1_t *stack, int top) {
	ke1_t *ori;
	ori = &stack[--top];
...
static int ke_plspage(ke1_t *stack, int top) {
...
static int ke_plspal0(ke1_t *stack, int top) {
	ke1_t *filename;
	filename = &stack[--top];
...
static int ke_plspal1(ke1_t *stack, int top) {
...
static int ke_plsstrm(ke1_t *stack, int top) {
	ke1_t *strm;
	strm = &stack[--top];
...
static int ke_plssub(ke1_t *stack, int top) {
	ke1_t *nx, *ny;
	ny = &stack[--top];
	nx = &stack[--top];
...
static int ke_plssym(ke1_t *stack, int top) {
	ke1_t *def, *scale;
	scale = &stack[--top];
	def = &stack[--top];
...
static int ke_plstar(ke1_t *stack, int top) {
	ke1_t *nx, *ny;
	ny = &stack[--top];
	nx = &stack[--top];
...
static int ke_plstart(ke1_t *stack, int top) {
	ke1_t *devname, *nx, *ny;
	ny = &stack[--top];
	nx = &stack[--top];
	devname = &stack[--top];
...
static int ke_plstransform(ke1_t *stack, int top) {
...
static int ke_plstring(ke1_t *stack, int top) {
	ke1_t *n, *x, *y, *string;
	string = &stack[--top];
	y = &stack[--top];
	x = &stack[--top];
...
static int ke_plstring3(ke1_t *stack, int top) {
...
static int ke_plstripa(ke1_t *stack, int top) {
	ke1_t *id, *pen, *x, *y;
	y = &stack[--top];
	x = &stack[--top];
	pen = &stack[--top];
...
static int ke_plstripc(ke1_t *stack, int top) {
	...
	plstripc(
		(PLINT_NC_SCALAR)(&(g_gbl_fields[id->ifield]->i)),
...
static int ke_plstripd(ke1_t *stack, int top) {
	ke1_t *id;
	id = &stack[--top];
...
static int ke_plstyl(ke1_t *stack, int top) {
...
static int ke_plsurf3d(ke1_t *stack, int top) {
	ke1_t *x, *y, *z, *nx, *ny, *opt, *clevel, *nlevel;
	nlevel = &stack[--top];
	clevel = &stack[--top];
	opt = &stack[--top];
...
static int ke_plsurf3dl(ke1_t *stack, int top) {
	ke1_t *x, *y, *z, *nx, *ny, *opt, *clevel, *nlevel, *indexxmin, *indexxmax, *indexymin, *indexymax;
	indexymax = &stack[--top];
	indexymin = &stack[--top];
	indexxmax = &stack[--top];
...
static int ke_plsvect(ke1_t *stack, int top) {
...
static int ke_plsvpa(ke1_t *stack, int top) {
	ke1_t *xmin, *xmax, *ymin, *ymax;
	ymax = &stack[--top];
	ymin = &stack[--top];
	xmax = &stack[--top];
...
static int ke_plsxax(ke1_t *stack, int top) {
	ke1_t *digmax, *digits;
	digits = &stack[--top];
	digmax = &stack[--top];
...
static int ke_plsyax(ke1_t *stack, int top) {
	ke1_t *digmax, *digits;
	digits = &stack[--top];
	digmax = &stack[--top];
...
static int ke_plsym(ke1_t *stack, int top) {
	ke1_t *n, *x, *y, *code;
	code = &stack[--top];
	y = &stack[--top];
	x = &stack[--top];
...
static int ke_plszax(ke1_t *stack, int top) {
	ke1_t *digmax, *digits;
	digits = &stack[--top];
	digmax = &stack[--top];
...
static int ke_pltext(ke1_t *stack, int top) {
	pltext();
	return top;
}

static int ke_pltimefmt(ke1_t *stack, int top) {
	ke1_t *fmt;
	fmt = &stack[--top];
...
static int ke_plvasp(ke1_t *stack, int top) {
	ke1_t *aspect;
	aspect = &stack[--top];
...
static int ke_plvect(ke1_t *stack, int top) {
...
static int ke_plvpas(ke1_t *stack, int top) {
...
static int ke_plvpor(ke1_t *stack, int top) {
	ke1_t *xmin, *xmax, *ymin, *ymax;
	ymax = &stack[--top];
	ymin = &stack[--top];
	xmax = &stack[--top];
...
static int ke_plvsta(ke1_t *stack, int top) {
	plvsta();
	return top;
}

static int ke_plw3d(ke1_t *stack, int top) {
...
static int ke_plwidth(ke1_t *stack, int top) {
	ke1_t *width;
	width = &stack[--top];
...
static int ke_plwind(ke1_t *stack, int top) {
	ke1_t *xmin, *xmax, *ymin, *ymax;
	ymax = &stack[--top];
	ymin = &stack[--top];
	xmax = &stack[--top];
...
static int ke_plxormod(ke1_t *stack, int top) {
	ke1_t *mode, *status;
	status = &stack[--top];
	mode = &stack[--top];

	plxormod((PLBOOL)mode->i,
		(PLBOOL_NC_SCALAR)(&(g_gbl_fields[status->ifield]->i)));
	return top;
}
